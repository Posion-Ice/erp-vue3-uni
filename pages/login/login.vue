	...
	<view class="container">
		...
		<view class="box">
			...
			<u-form ref="uForm" :borderBottom="false" :model="form">
				<!-- 用户名 -->
				<u-form-item leftIcon="account-fill" :borderBottom="false" :leftIconStyle="{'padding': '20rpx'}" prop="username" class="vk-form-item">
					<u-input type="text" placeholder="请输入用户名" v-model="form.username" class="vk-input" />
				</u-form-item>
				<!-- 密码 -->
				<u-form-item leftIcon="lock" :borderBottom="false" :leftIconStyle="{'padding': '20rpx'}" prop="password" class="vk-form-item">
					<u-input type="password" placeholder="请输入登录密码" v-model="form.password" class="vk-input" />
				</u-form-item>
			</u-form>
			<!-- 登录按钮 -->
			<u-button type="primary" style="width: 94vw; border-radius: 50rpx; margin: 8vh auto;">登录</u-button>
		</view>
